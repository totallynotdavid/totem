export const GREETING = [
  ["¡Hola! 👋 Somos Cálidda. ¿Eres el titular de tu servicio de gas natural?"],
  ["Hola, te escribe Cálidda. ¿El servicio de gas está a tu nombre?"],
  ["¡Qué tal! Somos Cálidda. ¿Tu servicio de gas está a tu nombre?"],
  ["Hola 👋 Somos Cálidda. El servicio de gas está a tu nombre?"],
];
