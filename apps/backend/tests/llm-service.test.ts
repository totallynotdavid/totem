...
describe("LLM Service - Intent Classification", () => {
  ...
  test.skipIf(FORCE_SKIP)(
    "should classify simple affirmation as 'yes'",
    async () => {
  ...
  test.skipIf(FORCE_SKIP)(
    "should classify question with '?' as 'question'",
    async () => {
  ...
  test.skipIf(FORCE_SKIP)(
    "should classify question without '?' as 'question'",
    async () => {
  ...
  test.skipIf(FORCE_SKIP)(
    "should classify complex product question as 'question'",
    async () => {
      const result = await LLM.classifyIntent(
        "Me puedes decir qué productos tienen disponibles",
      );
      expect(result).toBe("question");
    },
  );
  ...
  test.skipIf(FORCE_SKIP)(
    "should handle informal Peruvian Spanish questions",
    async () => {
  ...
  test.skipIf(FORCE_SKIP)(
    "should classify unclear gibberish as 'unclear'",
    async () => {
...
describe("LLM Service - Entity Extraction", () => {
  ...
  test.skipIf(FORCE_SKIP)(
    "should extract category from brand name (iPhone → celulares)",
    async () => {
  ...
  test.skipIf(FORCE_SKIP)(
    "should extract category from informal request (refri)",
    async () => {
      const result = await LLM.extractEntity(
        "una refri pe",
        "product_category",
  ...
  test.skipIf(FORCE_SKIP)(
    "should extract category from complex sentence",
    async () => {
      const result = await LLM.extractEntity(
  ...
  test.skipIf(FORCE_SKIP)(
    "should map Samsung to celulares category",
    async () => {
      const result = await LLM.extractEntity(
        "Un Samsung Galaxy",
        "product_category",
  ...
  test.skipIf(FORCE_SKIP)(
    "should return null when no category found",
    async () => {
      const result = await LLM.extractEntity(
        "Hola, buenos días",
        "product_category",
  ...
  test.skipIf(FORCE_SKIP)(
    "should handle mixed categories and pick primary intent",
    async () => {
      const result = await LLM.extractEntity(
  ...
  test.skipIf(FORCE_SKIP)(
    "should work with custom/dynamic categories from database",
    async () => {
...
describe("LLM Service - Question Answering", () => {
  test.skipIf(FORCE_SKIP)(
    "should answer financing question WITHOUT escalating",
    async () => {
  ...
  test.skipIf(FORCE_SKIP)(
    "should answer product availability question WITHOUT escalating",
    async () => {
      ...
      const productMentions = (
        result.answer
          .toLowerCase()
          .match(/celular|laptop|cocina|tv|refrigerad|terma/g) || []
      ).length;
  ...
  test.skipIf(FORCE_SKIP)(
    "should answer zone coverage question WITHOUT escalating",
    async () => {
      const result = await LLM.answerQuestion("¿Hacen envíos a Arequipa?", {
        segment: "fnb",
        creditLine: 5000,
      });
  ...
  test.skipIf(FORCE_SKIP)(
    "should ESCALATE on specific cuota amount question",
    async () => {
      const result = await LLM.answerQuestion(
  ...
  test.skipIf(FORCE_SKIP)(
    "should ESCALATE on interest rate question",
    async () => {
      const result = await LLM.answerQuestion("¿Qué tasa de interés manejan?", {
        segment: "fnb",
        creditLine: 4000,
      });
  ...
  test.skipIf(FORCE_SKIP)(
    "should ESCALATE on approval guarantee request",
    async () => {
      const result = await LLM.answerQuestion("¿Me van a aprobar seguro?", {
        segment: "gaso",
        creditLine: 1500,
      });
  ...
  test.skipIf(FORCE_SKIP)(
    "should handle informal Peruvian Spanish naturally",
    async () => {
      const result = await LLM.answerQuestion(
  ...
  test.skipIf(FORCE_SKIP)(
    "should close with product interest question",
    async () => {
      const result = await LLM.answerQuestion("¿Qué zonas cubren?", {
        segment: "fnb",
        creditLine: 5000,
      });
...
describe("LLM Service - Prompt Quality Checks", () => {
  test.skipIf(FORCE_SKIP)(
    "should maintain conversational tone across multiple questions",
    async () => {
      const questions = [
        "¿Cómo funciona el financiamiento?",
  ...
  test.skipIf(FORCE_SKIP)(
    "should respect sales context boundaries",
    async () => {
      const result = await LLM.answerQuestion(
